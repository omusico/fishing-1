...
class CI_DB_active_record extends CI_DB_driver {
	...
	var $small_cache		    = array();
	var $small_table		    = array();
	var $small_field		    = array();
	// --------------------------------------------------------------------
	...
	public function create($table='')
	{
		if ($table!='')
			$this->small_table=$table;
		$this->load_cache($this->small_table);
		if (empty($this->small_field)){
			$field=$this->small_cache[$this->small_table];//not set field,get all
		}else{
